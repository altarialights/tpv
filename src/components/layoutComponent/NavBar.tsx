            ...
            <section className={`flex flex-col h-screen gap-3 transition-all duration-500 ${open ? "w-60" : "w-12"}`}>
                ...
                <nav className="flex flex-col justify-between h-full w-fit p-2">
                    <div className="flex flex-col gap-3 w-fit">
                        <NavBarItem pagina="Mesas" svg={MesaSVG} abierto={open} />
                        <NavBarItem pagina="Inventario" svg={InventarioSVG} abierto={open} />
                        <NavBarItem pagina="Reservas" svg={ReservasSVG} abierto={open} />
                        <NavBarItem pagina="Trabajadores" svg={TrabajadoresSVG} abierto={open} />
                        <NavBarItem pagina="Proveedores" nombre="Proveedores y Pedidos" svg={ProveedoresSVG} abierto={open} />
                        <NavBarItem pagina="Clientes" svg={ClienteSVG} abierto={open} />
                        <NavBarItem pagina="Estadisticas" svg={EstadisticasSVG} abierto={open} />
                    </div>
                    <div className="flex flex-col gap-3 w-fit">
                        <NavBarItem pagina="Configuracion" nombre='Configuración' svg={ConfiguracionSVG} abierto={open} />
                        <NavBarItem pagina="Logout" nombre="Cerrar Sesión" svg={LogoutSVG} abierto={open} />
                    </div>
                </nav>
            </section>
        );
